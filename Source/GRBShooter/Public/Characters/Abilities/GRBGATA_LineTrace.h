...
#include "GRBGATA_LineTrace.generated.h"

/**
 * 蓝图可重用的 LineTrace版本 场景探查器
 * Reusable, configurable line trace TargetActor.
 * Meant to be used with GRBAT_WaitTargetDataUsingActor instead of the default WaitTargetData AbilityTask as the default one will destroy the TargetActor.
 */
UCLASS()
class GRBSHOOTER_API AGRBGATA_LineTrace : public AGRBGATA_Trace
{
	GENERATED_BODY()
